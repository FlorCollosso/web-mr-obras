...
function FbIcon()    { return <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg> }
...
function MailIcon()  { return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg> }
...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-dark border-t border-white/10 overflow-hidden">
      ...
      <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[520px] h-[280px] rounded-full bg-primary-500/10 blur-[100px] pointer-events-none" />

      <div className="relative max-w-[1300px] mx-auto px-6 lg:px-8 py-14">
        <div className="flex flex-col md:flex-row md:justify-between gap-10 pb-10 border-b border-white/10
                        text-center md:text-left items-center md:items-end">

          {/* Brand */}
          <div className="flex flex-col items-center md:items-start">
            <Link to="/#inicio" className="inline-flex items-center mb-4">
              <img src={logo} alt="MR Obras" className="h-12 w-auto" />
            </Link>
            <p className="text-sm text-white/50 leading-relaxed max-w-xs">
              Empresa constructora especializada en steel framing y construcción
              tradicional. Córdoba, Argentina.
            </p>
          ...
          <div className="flex flex-col items-center md:items-end">
            <p className="text-xs font-bold text-primary-400 uppercase tracking-widest mb-4">
              Contacto
            </p>
            <div className="flex flex-col items-center md:items-end gap-3 text-sm text-white/55">
              <a href="mailto:hola@mrobras.com.ar" className="flex items-center gap-2.5 hover:text-primary-300 transition-colors">
                <MailIcon /> contacto@mrobras.com.ar
              </a>
              <span className="flex items-center gap-2.5">
                <PinIcon /> El Tio, Córdoba, Argentina
              </span>
              <span className="flex items-center gap-2.5">
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-white/35">
          <p>© {year} MR Obras. Todos los derechos reservados.</p>
          <p>Soluciones integrales para su proyecto</p>
        </div>
      </div>
    </footer>
  )
