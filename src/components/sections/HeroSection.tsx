  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(106deg, rgba(100,100,100,0.75) 0%, rgba(0,38,37,0.85) 100%)',
        }}
      />
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-[1300px] mx-auto px-6 lg:px-8 w-full">
          <div
            className={`max-w-[860px] transition-all duration-500 ${
              animating
          ...
          <a
            href="#contacto"
            className="btn-primary text-md md:text-md px-6 py-2"
          >
